...
**URL:** [https://www.w3.org/standards/](https://www.w3.org/standards/)
...
**Human URL:** [https://html.spec.whatwg.org/multipage/](https://html.spec.whatwg.org/multipage/)
...
- [GitHubRepository](https://github.com/whatwg/html)
...
**Human URL:** [https://fetch.spec.whatwg.org/](https://fetch.spec.whatwg.org/)
...
- [Documentation](https://fetch.spec.whatwg.org/)
- [GitHubRepository](https://github.com/whatwg/fetch)

### WHATWG DOM Living Standard
The core infrastructure used to define the web, specifying the Document Object Model.

**Human URL:** [https://dom.spec.whatwg.org/](https://dom.spec.whatwg.org/)
...
- [GitHubRepository](https://github.com/whatwg/dom)

### WHATWG URL Living Standard
Infrastructure and algorithms around URLs on the web, including URL and URLSearchParams APIs.

**Human URL:** [https://url.spec.whatwg.org/](https://url.spec.whatwg.org/)
...
- [Documentation](https://url.spec.whatwg.org/)
- [GitHubRepository](https://github.com/whatwg/url)
...
**Human URL:** [https://streams.spec.whatwg.org/](https://streams.spec.whatwg.org/)
...
- [Documentation](https://streams.spec.whatwg.org/)
- [GitHubRepository](https://github.com/whatwg/streams)
...
**Human URL:** [https://websockets.spec.whatwg.org/](https://websockets.spec.whatwg.org/)
...
- [Documentation](https://websockets.spec.whatwg.org/)
- [GitHubRepository](https://github.com/whatwg/websockets)

### W3C CSS Specifications
Cascading Style Sheets specifications covering layout, selectors, animations, and all aspects of web presentation.

**Human URL:** [https://www.w3.org/Style/CSS/](https://www.w3.org/Style/CSS/)
...
- [GitHubOrganization](https://github.com/w3c/csswg-drafts)

### W3C Web Authentication (WebAuthn)
A W3C Recommendation defining strong authentication using public key cryptography for passwordless login.

**Human URL:** [https://www.w3.org/TR/webauthn/](https://www.w3.org/TR/webauthn/)
...
- [Documentation](https://www.w3.org/TR/webauthn/)
- [GitHubRepository](https://github.com/w3c/webauthn)

### W3C WebRTC
Web Real-Time Communications enabling peer-to-peer audio, video, and data communication in browsers.

**Human URL:** [https://www.w3.org/TR/webrtc/](https://www.w3.org/TR/webrtc/)
...
- [Documentation](https://www.w3.org/TR/webrtc/)
- [GitHubRepository](https://github.com/w3c/webrtc-pc)

### W3C WebGPU
A W3C specification providing modern GPU-accelerated graphics and compute capabilities for the web.

**Human URL:** [https://www.w3.org/TR/webgpu/](https://www.w3.org/TR/webgpu/)
...
- [GitHubRepository](https://github.com/gpuweb/gpuweb)

### W3C Web Components
Custom Elements, Shadow DOM, and HTML Templates for building reusable encapsulated UI components.

**Human URL:** [https://www.w3.org/standards/techs/components](https://www.w3.org/standards/techs/components)
...
- [GitHubRepository](https://github.com/WICG/webcomponents)

### W3C Service Workers
Enables offline web apps, background synchronization, and programmable network request interception.

**Human URL:** [https://www.w3.org/TR/service-workers/](https://www.w3.org/TR/service-workers/)
...
- [Documentation](https://www.w3.org/TR/service-workers/)
- [GitHubRepository](https://github.com/w3c/ServiceWorker)

### W3C Payment Request API
Standardizes the web checkout process using browser-stored payment information.

**Human URL:** [https://www.w3.org/TR/payment-request/](https://www.w3.org/TR/payment-request/)
...
- [Documentation](https://www.w3.org/TR/payment-request/)
- [GitHubRepository](https://github.com/w3c/payment-request)

### W3C WebAssembly
Portable binary instruction format enabling near-native performance for web applications.

**Human URL:** [https://www.w3.org/TR/wasm-core-1/](https://www.w3.org/TR/wasm-core-1/)
...
- [GitHubRepository](https://github.com/WebAssembly/spec)

### W3C JSON-LD
JSON-LD 1.1 W3C Recommendation for Linked Data in JSON, enabling semantic web interoperability.

**Human URL:** [https://www.w3.org/TR/json-ld11/](https://www.w3.org/TR/json-ld11/)
...
- [GitHubRepository](https://github.com/w3c/json-ld-syntax)

### W3C Verifiable Credentials
Data model for cryptographically secure, privacy-respecting, machine-verifiable digital credentials.

**Human URL:** [https://www.w3.org/TR/vc-data-model/](https://www.w3.org/TR/vc-data-model/)
...
- [GitHubRepository](https://github.com/w3c/vc-data-model)

### W3C Web Neural Network API (WebNN)
Hardware-accelerated machine learning inference directly in web browsers.

**Human URL:** [https://www.w3.org/TR/webnn/](https://www.w3.org/TR/webnn/)
...
- [Documentation](https://www.w3.org/TR/webnn/)
- [GitHubRepository](https://github.com/webmachinelearning/webnn)

### W3C Decentralized Identifiers (DIDs)
Globally unique, cryptographically verifiable identifiers for decentralized digital identity.

**Human URL:** [https://www.w3.org/TR/did-core/](https://www.w3.org/TR/did-core/)
...
- [GitHubRepository](https://github.com/w3c/did-core)

### IETF HTTP Specifications
HTTP/1.1, HTTP/2, HTTP/3, and related networking protocol standards.

**Human URL:** [https://httpwg.org/](https://httpwg.org/)
...
- [Documentation](https://httpwg.org/specs/)
- [GitHubOrganization](https://github.com/httpwg)
...
**Human URL:** [https://ecma-international.org/publications-and-standards/standards/ecma-262/](https://ecma-international.org/publications-and-standards/standards/ecma-262/)
...
- [GitHubRepository](https://github.com/tc39/ecma262)
- [GitHubOrganization](https://github.com/tc39)
...
- [TC39 GitHub Organization](https://github.com/tc39)
- [WICG GitHub Organization](https://github.com/WICG)
...
- [Web Standards Vocabulary](vocabulary/web-standards-vocabulary.yml) — Unified taxonomy mapping 6 resources, 5 actions, 6 workflows, and 8 personas across the web standards landscape
